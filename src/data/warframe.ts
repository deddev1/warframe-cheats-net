...
export const warframeImages = {
	...
	product: [
		{ src: wt2, alt: 'Warframe ESP overlay with enemy Warframe boxes and health bars' },
		{ src: wt3, alt: 'Warframe wallhack ESP outline boxes on enemy Warframes in Steel Path missions' },
		{ src: wt4, alt: 'Warframe aimbot lock on enemy Warframe weak spots during mission fight' },
	...
	gallery: [
		...
		{ src: wt2, alt: 'Warframe ESP overlay showing enemy Warframes and Sentients through terrain', href: '/warframe-esp/' },
		{ src: wt3, alt: 'Warframe wallhack ESP with enemy outline boxes in Steel Path missions', href: '/warframe-wallhack/' },
		{ src: wt4, alt: 'Warframe aimbot targeting enemy Warframe weak spots', href: '/warframe-aimbot/' },
	...
	sitemap: [
		...
		{ src: wt2, title: 'Warframe ESP overlay', caption: 'Warframe ESP wallhack showing enemy Warframe positions and health' },
		{ src: wt3, title: 'Warframe wallhack ESP', caption: 'Warframe wallhack outline boxes on enemy Warframes in Steel Path missions' },
		{ src: wt4, title: 'Warframe aimbot targeting', caption: 'Warframe aimbot lock on enemy Warframe weak spots during mission fight' },
