...
const REPLACEMENTS = [
	...
	['call-of-duty-warzone-cheats', 'overwatch-cheats'],
	...
	['ricochet', 'eac'],
	['support@warzonescheats.net', 'support@overwatchhacks.com'],
	['Verdansk, Urzikstan, and Rebirth Island', 'control points, payload routes, and ranked seasons'],
	['Verdansk, Urzikstan and Rebirth Island', 'control points, payload routes and ranked seasons'],
	['gulag fights', 'map rotations'],
	['gulag fight', 'payload route fight'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and competitive', 'control points and raids'],
	['BR and Resurgence', 'Quick Play and Competitive'],
...
phrases = phrases.replace(
	...
	radar: 'radar hack',
	aimbot: 'Aimbot',
	product: 'Overwatch Hacks',
	game: 'Rust',
	checkout: 'Zadeyo',
	eac: 'Blizzard anti-cheat (EAC)',
};`,
);
phrases = phrases.replace(/KW\.ricochet/g, 'KW.eac');
phrases = phrases.replace(/maps: '[^']*'/g, "maps: 'control points, payload routes, and ranked seasons'");
