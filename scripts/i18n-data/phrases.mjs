...
export const phrases = {
	es: {
		buy: 'Comprar Overwatch Hacks', undetected: 'indetectables', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'Contacta support@overwatchhacks.com para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Overwatch Hacks', undetected: 'indétectables', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'Contactez support@overwatchhacks.com pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Overwatch Hacks kaufen', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Overwatch Hacks', undetected: 'indetectáveis', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'Contacte support@overwatchhacks.com para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Overwatch Hacks', undetected: 'indetectable', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'Contatta support@overwatchhacks.com per supporto o richieste legali.',
	},
	nl: {
		buy: 'Overwatch Hacks kopen', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Overwatch Hacks satın al', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'Destek ve yasal sorular için support@overwatchhacks.com.',
	},
	ar: {
		buy: 'اشترِ Overwatch Hacks', undetected: 'غير مكتشف', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Overwatch Hacksを購入', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'サポート・法務: support@overwatchhacks.com',
	},
	ko: {
		buy: 'Overwatch Hacks 구매', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => '지원 및 법무: support@overwatchhacks.com',
	},
	zh: {
		buy: '购买 Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => '支持与法务：support@overwatchhacks.com',
	},
	hi: {
		buy: 'Overwatch Hacks खरीदें', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'सहायता: support@overwatchhacks.com',
	},
	id: {
		buy: 'Beli Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Overwatch Hacks', undetected: 'undetected', maps: 'control points, flank routes, and map objectives',
		...
		legal: () => 'support@overwatchhacks.com för support och juridik.',
	},
};
