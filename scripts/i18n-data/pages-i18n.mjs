...
function buildLegal(locale, pageKey, kind) {
	...
	return {
		...
		h1,
		intro: p.s1(`${h1} for warthunderhacks.com and War Thunder licenses.`),
		...
		sections: [
			section(
				...
				kind === 'privacy' ? 'Payment details are processed by Zadeyo checkout — not stored on warthunderhacks.com.' : p.s2(),
			),
			section(
