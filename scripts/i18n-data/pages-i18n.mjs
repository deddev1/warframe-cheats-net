...
const PAGE_META_TAILS = {
	'warframe-esp': { suffix: 'Player Boxes & Wallhack', focus: 'player boxes, health pickup markers, and wallhack overlays' },
