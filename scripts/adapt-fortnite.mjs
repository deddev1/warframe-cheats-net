...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'Warframe missions, open world missions, and Steel Path missions lobbies'],
	['Verdansk, Urzikstan and Rebirth Island', 'Warframe missions, open world missions and Steel Path missions lobbies'],
	['Verdansk, Urzikstan, et Rebirth Island', 'Warframe missions, open world missions et lobbies compétitifs'],
	['Verdansk, Urzikstan e Rebirth Island', 'Warframe missions, open world missions e lobbies competitivi'],
	['Verdansk, Urzikstan und Rebirth Island', 'Warframe missions, open world missions und Steel Path missions-Lobbys'],
	['gulag fights', 'respawn wave rotations'],
	['gulag fight', 'respawn wave fight'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and Steel Path missions', 'open world missions and Steel Path missions'],
	['BR and Resurgence', 'BR and open world missions'],
	['BR & Resurgence', 'BR & open world missions'],
	['loadout drops', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'Warframe missions'],
