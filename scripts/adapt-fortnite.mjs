...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'War Thunder maps, Arcade Battles, and realistic battles lobbies'],
	['Verdansk, Urzikstan and Rebirth Island', 'War Thunder maps, Arcade Battles and realistic battles lobbies'],
	['Verdansk, Urzikstan, et Rebirth Island', 'War Thunder maps, Arcade Battles et lobbies compétitifs'],
	['Verdansk, Urzikstan e Rebirth Island', 'War Thunder maps, Arcade Battles e lobbies competitivi'],
	['Verdansk, Urzikstan und Rebirth Island', 'War Thunder maps, Arcade Battles und Realistic Battles-Lobbys'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and Realistic Battles', 'Arcade Battles and Realistic Battles'],
	['BR and Resurgence', 'BR and Arcade Battles'],
	['BR & Resurgence', 'BR & Arcade Battles'],
	['loadout drops', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'War Thunder maps'],
