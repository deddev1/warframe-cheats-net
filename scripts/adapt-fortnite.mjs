...
const REPLACEMENTS = [
	...
	['ricochet', 'eac'],
	['Verdansk, Urzikstan, and Rebirth Island', 'Overwatch maps, Quick Play, and competitive lobbies'],
	['Verdansk, Urzikstan and Rebirth Island', 'Overwatch maps, Quick Play and competitive lobbies'],
	['Verdansk, Urzikstan, et Rebirth Island', 'Overwatch maps, Quick Play et lobbies compétitifs'],
	['Verdansk, Urzikstan e Rebirth Island', 'Overwatch maps, Quick Play e lobbies competitivi'],
	['Verdansk, Urzikstan und Rebirth Island', 'Overwatch maps, Quick Play und Competitive-Lobbys'],
	...
	['Operator', 'Player'],
	['UAV', 'supply drop'],
	['Resurgence and Competitive', 'Quick Play and Competitive'],
	['BR and Resurgence', 'BR and Quick Play'],
	['BR & Resurgence', 'BR & Quick Play'],
	['loadout drops', 'loot chests'],
	['loadout drop', 'loot chest'],
	['contracts', 'chests'],
	['contract', 'chest'],
	['Al Mazrah', 'Overwatch maps'],
